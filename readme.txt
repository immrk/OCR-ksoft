...
注意：以下教程与代码均使用开源ocr功能软件tesseract-ocr；
          以下代码与教程均要求电脑安装有python编译环境
——————————————————————————————
准备步骤：
1.下载安装开源软件tesseract-ocr，官网链接如下：https://tesseract-ocr.github.io/docs/
...
注意：本项目代码部分基于该视频博主代码改造。此教程视频不包含手写识别教程，手写识别数据库为本人制造
