...
class Application(tk.Tk):
    ...
    def __init__(self):
        super().__init__()
        self.title("KSOFT-OCR图片文本提取工具")

        pt.pytesseract.tesseract_cmd = r"D:\tesseract_ocr\tesseract.exe"
